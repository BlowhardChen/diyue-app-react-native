...
const HistoryWorkDetailScreen = observer(() => {
    ...
    <View style={FarmingDetailScreenStyles.container}>
      ...
      <LinearGradient
        ...
        <View style={FarmingWorkDataScreenStyles.header}>
          ...
          <Text style={FarmingWorkDataScreenStyles.title}>历史详情</Text>
      ...
      <View style={FarmingDetailScreenStyles.mapBox}>
        ...
        {/* 历史详情弹窗 */}
        <HistoryWorkDetailPopup />
      </View>
    </View>
  );
});

export default HistoryWorkDetailScreen;
